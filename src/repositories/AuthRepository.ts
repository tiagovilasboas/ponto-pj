...
export class AuthRepository {
  ...
  async signUp(
    ...
    // Para segurança, não revelamos se o e-mail já existe
    // Sempre retornamos sucesso para evitar enumeração de usuários
    if (error) {
      // Se for erro de e-mail já existente, simulamos sucesso
      if (
        ...
        // Retornamos sucesso para não revelar que o e-mail existe
